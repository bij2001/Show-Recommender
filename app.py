...
st.image("Header.png", caption=None, width=None, use_column_width=None, clamp=False, channels="RGB", output_format="auto")

st.title("Show Recommender")
movies_list=pickle.load(open('movies.pkl','rb'))

option=st.selectbox('Type to select any show which you have previously watched?',movies_list)
